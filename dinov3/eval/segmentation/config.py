...
class DatasetConfig:
    ...
    format: str = "builtin"  # [builtin, tif_mask_pairs]
    train: str = ""  # Dataset descriptor, e.g. "ADE20K:split=TRAIN"
    val: str = ""
    train_images: str | None = None
    train_masks: str | None = None
    val_images: str | None = None
    val_masks: str | None = None
    label_values: tuple[int, ...] = (0, 80, 160, 240)


@dataclass
class InputAdapterConfig:
    in_channels: int = 3
    mode: str = "identity"  # [identity, repeat, conv]
...
class TrainTransformConfig:
    ...
    flip_prob: float = 0.0
    enable_photometric_distortion: bool = False
